...
<div id="sub_menu" class="btn-group">
	<a href="<?php echo site_url("regimen_management");?>" class="btn  first_link <?php if($quick_link == "regimen"){echo "top_menu_active";}?>">Regimens</a>
	<a href="<?php echo site_url("pipeline_management");?>" class="btn first_link <?php if($quick_link == "pipeline"){echo "top_menu_active";}?>">Pipeline Upload</a>
	<a href="<?php echo site_url("fcdrr_management");?>" class="btn first_link <?php if($quick_link == "fcdrr"){echo "top_menu_active";}?>">FCDRR Upload</a>
