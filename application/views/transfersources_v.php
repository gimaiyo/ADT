...
<a class="action_button" id="new_client">New Transfer Source</a>
<div class="passmessage"></div>
<div class="errormessage"></div>
<?php
echo $sources;
?>
<div id="client_form" title="New Transfer Source">
	<?php
	$attributes = array('class' => 'input_form');
	echo form_open('transfersource_management/save', $attributes);
	echo validation_errors('<p class="error">', '</p>');
	?>
		
	<label>
<strong class="label">Transfer Source Name</strong>
