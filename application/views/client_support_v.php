...
<div id="view_content">
	  ...
	  <div class="row-fluid row">
	    ...
	    <div class="span9 span-fixed-sidebar">
	      	<div class="hero-unit">
				...
				<button class="btn btn-large btn-success" type="button" id="new_client"><i class="icon-plus icon-black"></i>New Client Support</button>
		        <?php echo $supports;?>
			</div>
	    </div><!--/span-->
	  </div><!--/row-->
	</div><!--/.fluid-container-->
	<div id="client_form" title="New Client Support">
		<?php
	...
	<div id="edit_form" title="Edit Client Support">
		<?php
		$attributes = array('class' => 'input_form');
