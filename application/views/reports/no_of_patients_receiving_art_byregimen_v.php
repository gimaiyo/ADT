...
<html lang="en" >
	<head>
		...
		<title>Active Patients on ART(By Regimen)</title>
	...
	<body>
				  ...
				  <li class="dropdown divider-vertical" id="visiting_patient">
				    ...
				    <b class="caret"></b>
				     ...
				     <ul class="dropdown-menu" id="visiting_patient_sub">
				      <li><a href="#" id="patients_scheduled_to_visit" class="report active_report single_date_report">List of Patients Scheduled to Visit</a></li>
				      <li><a href="#" id="patients_started_on_date" class="report active_report single_date_report">List of Patients Started (on a Particular Date)</a></li>
				      <li><a href="#" id="patients_visitied_for_refill" class="report active_report single_date_report">List of Patients Visited for Refill</a></li>
		...
		<h4 style="text-align: center">Active Patients Started By Regimen as of <input type="text" class="_date" id="date_of_appointment" value="<?php echo $from;?>"></h4>
