...
<div id="wrapperd">
	...
	<div id="patient_enrolled_content" class="full-content">
		...
		<h4 style="text-align: center">Listing of Patients Who Started Between <span class="_date" id="start_date"><?php echo $from;?></span> And <span class="_date" id="end_date"><?php echo $to;?></span></h4>
