...
<html lang="en" >
	...
	<body>
		...
		<h4 style="text-align: center">Cumulative Number of Patients by Current Status as of <input type="text" class="_date" id="date_of_appointment" value="<?php echo $from;?>"></h4>
