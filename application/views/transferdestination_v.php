...
<a class="action_button" id="new_client">New Transfer To</a>
<div class="passmessage"></div>
<div class="errormessage"></div>
<?php
echo $sources;
?>
<div id="client_form" title="New Transfer Destination">
	<?php
	$attributes = array('class' => 'input_form');
	echo form_open('transferdestination_management/save', $attributes);
	echo validation_errors('<p class="error">', '</p>');
	?>
		
	<label>
<strong class="label">Transfer Destination Name</strong>
<input type="text" name="source_name" id="source_name" class="input" size="30">
</label>
