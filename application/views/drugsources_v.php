...
<div id="view_content">
	  ...
	  <div class="row-fluid row">
	    ...
	    <div class="span12 span-fixed-sidebar">
	      	<div class="hero-unit">
				...
				<button class="btn btn-large btn-success" type="button" id="new_client"><i class="icon-plus icon-black"></i>New Drug Source</button>
		        <?php echo $sources;?>
			</div>
	    </div><!--/span-->
	  </div><!--/row-->
	</div><!--/.fluid-container-->
	<div id="client_form" title="New Drug Source">
		<?php
	...
	<div id="edit_form" title="Edit Drug Source">
		<?php
		$attributes = array('class' => 'input_form');
