			...
			<table>
				<tr>
					...
					<div class="input-prepend">
						...
						<input type="text" class="input-xxlarge" name="u_fullname" id="u_fullname" required="" value="<?php echo $this->session->userdata('full_name') ?>" />
					</div></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<div class="input-prepend">
						...
						<input type="tel" class="input-xlarge" name="u_phone" id="u_phone" value="<?php echo $this->session->userdata('Phone_Number') ?>"/>
					</div></td>
				</tr>
				<tr>
					<td>
